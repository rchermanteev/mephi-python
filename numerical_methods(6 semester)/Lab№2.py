...
plt.plot(xValue, exactU[len(exactU)//4*3], 'b')
plt.plot(xValue, U_O1[len(U_O1)//4*3], 'r')
plt.plot(xValue, U_O2[len(U_O2)//4*3], 'g')

plt.figure("Момент времени t = 1")
plt.plot(xValue, exactU[len(exactU)//2], 'b')
plt.plot(xValue, U_O1[len(U_O1)//2], 'r')
plt.plot(xValue, U_O2[len(U_O2)//2], 'g')
plt.show()
